...
// Begin of modification Permission Access for Export To Feature, by Deen Saleh, May 5, 2012
        global $Language, $Security, $users; // <-- Added $Security variable by Deen Saleh
...
<?php } ?>
<?php if ($users->CurrentAction == "" || $users->Export == "") { // Change && become || in order to add scroll table in Grid, by Deen Saleh, August 3, 2014 ?>
<script type="text/javascript">
