...
class ca_customers_add extends ca_customers {
	...
	function ShowMessage() {
		...
		if ($sSuccessMessage <> "") { // Message in Session, display
			...
			// Begin of modification Auto Hide Message, byDeen Saleh, January 24, 2013
			...
			// End of modification Auto Hide Message, byDeen Saleh, January 24, 2013
	...
	function Page_Init() {
		...
		// Begin of modification Auto Logout After Idle for the Certain Time, byDeen Saleh, May 5, 2012
		if (IsLoggedIn() && !IsSysAdmin()) {

			// Begin of modification byDeen Saleh, May 25, 2012 in order to not autologout after clear another user's session ID whenever back to another page.           
			$UserProfile->LoadProfileFromDatabase(CurrentUserName());

			// End of modification byDeen Saleh, May 25, 2012 in order to not autologout after clear another user's session ID whenever back to another page.
			// Begin of modification Save Last Users' Visitted Page, byDeen Saleh, May 25, 2012
			...
			// End of modification Save Last Users' Visitted Page, byDeen Saleh, May 25, 2012
		...
		// End of modification Auto Logout After Idle for the Certain Time, byDeen Saleh, May 5, 2012
		...
		if ($UserProfile->IsValidUser(CurrentUserName(), session_id())) {
			...
			// Begin of modification How to Overcome "User X already logged in" Issue, byDeen Saleh, July 22, 2014
			// echo $Language->Phrase("UserProfileCorrupted");

			header("Location: logout.php");

			// End of modification How to Overcome "User X already logged in" Issue, byDeen Saleh, July 22, 2014
		}
...
// Begin of modification Disable/Enable Registration Page, byDeen Saleh, May 14, 2012
// End of modification Disable/Enable Registration Page, byDeen Saleh, May 14, 2012
		// Page Load event
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			// End of modification Permission Access for Export To Feature, byDeen Saleh, May 5, 2012
		} else { // Not post back
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					// Begin of modification Disable Add/Edit Success Message Box, byDeen Saleh, August 1, 2012
					if (MS_SHOW_ADD_SUCCESS_MESSAGE==TRUE) {
						if ($this->getSuccessMessage() == "")
							$this->setSuccessMessage($Language->Phrase("AddSuccess")); // Set up success message
					}

					// End of modification Disable Add/Edit Success Message Box, byDeen Saleh, August 1, 2012
...
// Begin of modification Displaying Breadcrumb Links in All Pages, byDeen Saleh, May 4, 2012
getCurrentPageTitle(ew_CurrentPage());

// End of modification Displaying Breadcrumb Links in All Pages, byDeen Saleh, May 4, 2012
// Global Page Rendering event (in userfn*.php)

Page_Rendering();

// Global auto switch table width style (in userfn*.php), byDeen Saleh, January 7, 2015
