...
// End of modification Disable/Enable Registration Page, by Deen Saleh, May 14, 2012
	...
	var $Email = "";
	var $Username = ""; // added by Deen Saleh, April 21, 2014
	var $EmailOrUsername = ""; // added by Deen Saleh, April 22, 2014
	var $Action = "";
	var $ActivateCode = "";
		...
		*/
		...
		if ($this->Action <> "") {
			...
			if ($RsUser = $UserTableConn->Execute($sSql)) {
				if (!$RsUser->EOF) {
					$user_name = $RsUser->fields("Username"); // <-- // Saving the date and time of Reset Password, by Deen Saleh, October 7, 2013
					$rsold = $RsUser->fields;
					$bValidEmail = TRUE;
					...
					if ($bValidEmail) {
						...
						if (EW_ENCRYPTED_PASSWORD) {
							if (strtolower($this->Action) == "confirm") {
								...
								// Begin of modification saving the date and time of Reset Password, by Deen Saleh, October 7, 2013
								$UserProfile = new cUserProfile();
								...
								// End of modification saving the date and time of Reset Password, by Deen Saleh, October 7, 2013
							}
						} else {
			...
			if ($bEmailSent) {
				if ($this->getSuccessMessage() == "")
					if (strtolower($this->Action) == "confirm") {
						...
						// Begin of modification Log Reset Forgot Password into Audit Trail, by Deen Saleh, June 6, 2012
						...
						// End of modification Log Reset Forgot Password into Audit Trail, by Deen Saleh, June 6, 2012
					} else {
