...
class ca_customers_list extends ca_customers {
	...
	function ShowMessage() {
		...
		if ($sSuccessMessage <> "") { // Message in Session, display
			...
			// Begin of modification Auto Hide Message, by Deen Saleh, January 24, 2013
			...
			// End of modification Auto Hide Message, by Deen Saleh, January 24, 2013
	...
	function Page_Init() {
		...
		// Begin of modification Auto Logout After Idle for the Certain Time, by Deen Saleh, May 5, 2012
		if (IsLoggedIn() && !IsSysAdmin()) {

			// Begin of modification by Deen Saleh, May 25, 2012 in order to not autologout after clear another user's session ID whenever back to another page.           
			$UserProfile->LoadProfileFromDatabase(CurrentUserName());

			// End of modification by Deen Saleh, May 25, 2012 in order to not autologout after clear another user's session ID whenever back to another page.
			// Begin of modification Save Last Users' Visitted Page, by Deen Saleh, May 25, 2012
			...
			// End of modification Save Last Users' Visitted Page, by Deen Saleh, May 25, 2012
		...
		// End of modification Auto Logout After Idle for the Certain Time, by Deen Saleh, May 5, 2012
		...
		if ($UserProfile->IsValidUser(CurrentUserName(), session_id())) {
			...
			// Begin of modification How to Overcome "User X already logged in" Issue, by Deen Saleh, July 22, 2014
			// echo $Language->Phrase("UserProfileCorrupted");

			header("Location: logout.php");

			// End of modification How to Overcome "User X already logged in" Issue, by Deen Saleh, July 22, 2014
		}
		...
		// Begin of modification Permission Access for Export To Feature, by Deen Saleh, To prevent users entering from URL, May 12, 2012
		global $gsExport;
		if ($gsExport=="print") {
		...
		// End of modification Permission Access for Export To Feature, by Deen Saleh, To prevent users entering from URL, May 12, 2012
...
// Begin of modification Disable/Enable Registration Page, by Deen Saleh, May 14, 2012
// End of modification Disable/Enable Registration Page, by Deen Saleh, May 14, 2012
		// Page Load event
...
// Begin of modification Customize Navigation/Pager Panel, by Deen Saleh, May 2, 2012
    var $DisplayRecs = MS_TABLE_RECPERPAGE_VALUE;

// End of modification Customize Navigation/Pager Panel, by Deen Saleh, May 2, 2012
	var $SearchPanelCollapsed = TRUE; // Modified by Deen Saleh, September 23, 2014
	var $StartRec;
	var $StopRec;
	var $TotalRecs = 0;
	var $RecRange = 10;
	...
	// Begin of mofidication Flexibility of Export Records Options, by Deen Saleh, May 14, 2012     
	...
	// End of mofidication Flexibility of Export Records Options, by Deen Saleh, May 14, 2012
		// Export data only
		// Begin of modification Printer Friendly always does not use stylesheet, by Deen Saleh, October 8, 2013 (added "print" in array)

		if ($this->CustomExport == "" && in_array($this->Export, array("html","print","word","excel","xml","csv","email","pdf"))) {

		// End of modification Printer Friendly always does not use stylesheet, by Deen Saleh, October 8, 2013
			$this->ExportData();
		...
		for ($i = 0; $i < $cnt; $i++) {
			...
			foreach ($ar as $Keyword) {
				if ($Keyword <> "") {
					...
					// Begin of modification Exact Match search criteria, by Deen Saleh, November 12, 2014. See also: http://www.hkvforums.com/viewtopic.php?f=4&t=35853&p=104026#p104026
					if ($type == "=") {
						$sFldExpression = ($Fld->FldVirtualExpression <> $Fld->FldExpression) ? $Fld->FldVirtualExpression : $Fld->FldBasicSearchExpression;
						$sWrk = $sFldExpression . " = " . ew_QuotedValue("" . $Keyword . "", EW_DATATYPE_STRING);
					}

					// End of modification Exact Match search criteria, by Deen Saleh, November 12, 2014. See also: http://www.hkvforums.com/viewtopic.php?f=4&t=35853&p=104026#p104026
					if ($sWrk <> "") {
						$arSQL[$j] = $sWrk;
						$arCond[$j] = $sDefCond;
						$j += 1;
	...
	function SetupSearchOptions() {
		...
		// Begin of modification Customizing Search Panel, by Deen Saleh, for customize search panel, July 22, 2014
		...
		// End of modification Customizing Search Panel, by Deen Saleh, for customize search panel, July 22, 2014
		// Begin of modification Hide Search Button for Inline Edit and Inline Copy mode in List Page, by Deen Saleh, August 4, 2014
		...
		// End of modification Hide Search Button for Inline Edit and Inline Copy mode in List Page, by Deen Saleh, August 4, 2014			
		// Begin of modification Hide Search Button for Inline Edit and Inline Copy mode in List Page, by Deen Saleh, August 4, 2014
	...
	function RenderListOptionsExt() {
		...
		// Show detail items if necessary, modification based on v11.0.2, by Deen Saleh, October 13, 2014
		$showdtl = FALSE;
...
// Begin of modification Permission Access for Export To Feature, by Deen Saleh, May 5, 2012
        global $Language, $Security, $a_customers; // <-- Added $Security variable by Deen Saleh
...
// Begin of modification Displaying Breadcrumb Links in All Pages, by Deen Saleh, May 4, 2012
getCurrentPageTitle(ew_CurrentPage());

// End of modification Displaying Breadcrumb Links in All Pages, by Deen Saleh, May 4, 2012
// Global Page Rendering event (in userfn*.php)

Page_Rendering();

// Global auto switch table width style (in userfn*.php), by Deen Saleh, January 7, 2015
...
<?php // Begin of modification Displaying Empty Table, by Deen Saleh, May 3, 2012 ?>
...
<?php } ?>
<?php } ?>
<?php // End of modification Displaying Empty Table, by Deen Saleh, May 3, 2012 ?>
<?php //////////////////////////// END Empty Table ?>
<?php if ($a_customers_list->TotalRecs > 0 || $a_customers->CurrentAction <> "") { ?>
<div class="panel panel-default ewGrid">
<?php // Begin of modification Customize Navigation/Pager Panel, by Deen Saleh, May 2, 2012 ?>
<?php if ( (MS_PAGINATION_POSITION==1) || (MS_PAGINATION_POSITION==3) ) { ?>
<?php if ($a_customers->Export == "") { ?>
...
<?php } ?>
<?php } ?>
<?php // End of modification Customize Navigation/Pager Panel, by Deen Saleh, May 2, 2012 ?>
...
<?php } ?>
<input type="hidden" name="t" value="a_customers">
<?php // Begin of mofidication Flexibility of Export Records Options, by Deen Saleh, May 14, 2012 ?>
<?php if (MS_EXPORT_RECORD_OPTIONS=="selectedrecords") { ?>
<input type="hidden" name="exporttype" id="exporttype" value="">
<?php } ?>
<?php // End of mofidication Flexibility of Export Records Options, by Deen Saleh, May 14, 2012 ?>
...
<?php } ?>
<?php if ($a_customers->CurrentAction == "" || $a_customers->Export == "") { // Change && become || in order to add scroll table in Grid, by Deen Saleh, August 3, 2014 ?>
<script type="text/javascript">
<?php if (MS_TABLE_WIDTH_STYLE==1) { // Begin of modification Optimizing Main Table Width to Maximum Width of Site, by Deen Saleh, April 30, 2012 ?>
...
<?php } // End of modification Optimizing Main Table Width to Maximum Width of Site, by Deen Saleh, April 30, 2012 ?>
<?php } ?>
</script>
<?php } ?>
